    ...
    <div>
      ...
      <div className="relative w-full" style={{ height: "50vh" }}>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center w-full h-full gap-2 backdrop-blur-md">
          <h1 className="text-3xl md:text-5xl font-bold text-white font-playfair italic tracking-widest leading-normal max-w-3xl text-pretty ">
            {about.headline}
          </h1>
          <p className="font-light text-lg md:text-2xl max-w-lg tracking-wide text-foreground/90 leading-relaxed px-2">
            {about.subline}
          </p>
        </div>
      </div>
      ...
      <div className="py-6 flex flex-col items-center justify-start gap-6 relative px-4 ">
        <div className="flex flex-row items-center justify-center ">
          ...
          <h2 className="text-3xl md:text-4xl font-playfair font-bold tracking-widest italic">
            The Story Begins
          </h2>
        </div>
        <div className="flex flex-col items-left justify-center gap-2 max-w-4xl">
        ...
        <div className="flex flex-col items-left justify-center gap-4">
          {about.ethos.map((item, index) => (
            <div key={index} className="flex flex-row items-center justify-start gap-1">
              ...
              <p
                key={index}
                className="text-lg md:text-xl italic font-light tracking-wide text-left text-pretty "
              >
                {item}
              </p>
            </div>
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-between gap-4 max-w-2xl">
