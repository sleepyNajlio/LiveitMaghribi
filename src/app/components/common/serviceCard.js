...
export default function ServiceCard({ service }) {
  ...
  const blobMask = `<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className="w-full flex flex-col items-center justify-between relative ">
      <div
        className="w-full relative aspect-square z-10"
        style={{
          // marginBottom: "-7rem",
          // marginLeft: "4rem",
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/20 to-transparent rounded-xl py-11 px-8 flex flex-col justify-end">
          <h3 className=" mx-auto text-primary-foreground text-xl font-bold text-center px-6 min-h-[3rem] text-pretty tracking-wide">
            {service.title}
          </h3>
        </div>
      </div>
      <div className="text-center text-lg  italic font-playfair text-primary min-h-11 flex flex-col items-center justify-center w-full">
